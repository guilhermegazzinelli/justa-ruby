module Justa
  class OrderCommom < Model
    ...
    #
    # Request refund to Justa api for this order
    #
    ...
    def refund(params={})
      ...
      update Justa::Request.delete(url_delete('refund'), params: params.merge(client_key: @client_key)).call(underscored_class_name)
      self
    end
    ...
    #
    # Request order Cancel to Justa api
    #
    # @return [Order] Return model order instance
    def cancel()
      update Justa::Request.delete(url_delete, client_key: @client_key).call(underscored_class_name)
      self
    end
  end
end
